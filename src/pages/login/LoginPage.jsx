    ...
    <MainLayout isDarkMode={isDarkMode}>
      <section className={`container mx-auto px-5 py-10 dark:bg-[#050e15]`}>
        <div className="w-full max-w-sm mx-auto">
          <h1 className={`font-Roboto text-2xl font-bold text-center ${isDarkMode ? 'text-[#1E496A]' : 'text-dark-hard'} mb-8`}>
            Login
          </h1>
          <form onSubmit={handleSubmit(submitHandler)}>
            ...
            <button
              ...
              className={`bg-primary text-white font-bold text-lg py-4 px-8 w-full rounded-lg my-6 disabled:opacity-70 disabled:cursor-not-allowed ${isDarkMode ? 'dark:text-[#0D0D0D] dark:bg-[#2196f3]' : ''}`}
            >
              Sign In
            </button>
