...
const Header = () => {
  ...
  return (
    <header className="flex h-fit w-full items-center justify-between p-4 lg:h-full lg:max-w-[300px] lg:flex-col lg:items-start lg:justify-start lg:p-0 shadow-2xl">
      {/* logo */}
      <Link to="/">
